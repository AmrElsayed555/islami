...
import 'package:islami_1/home/suraNameWidged.dart';
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(
              child: Text("Verses Number",textAlign: TextAlign.center,style: TextStyle(
                fontSize: 20  ,
              ),),
            ),
          ],
        ...
        Expanded(
          ...
          child: ListView.separated(
            ...
            itemCount: suraNames.length,
              itemBuilder:(context,index)=> SuraNameWidged(
                index: index,
